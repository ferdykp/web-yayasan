...
class InquiryController extends Controller {
 ...
 $data=$request->validate(['name'=>'required|string|max:150','email'=>'required|email|max:255','phone'=>'nullable|string|max:30','message'=>'required|string|min:10|max:5000','type'=>'required|in:contact,tour','school_id'=>['nullable',Rule::exists('schools','id')->where('status','published')],'visit_date'=>'nullable|required_if:type,tour|date|after_or_equal:today','website'=>'nullable|max:0','consent'=>'accepted']);
