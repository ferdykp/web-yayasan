...
class PageResource extends ContentResource
{
    ...
    {
        return ['index' => PageResource\Pages\ListRecords::route('/'), 'create' => PageResource\Pages\CreateRecord::route('/create'), 'edit' => PageResource\Pages\EditRecord::route('/{record}/edit')];
    }
}
