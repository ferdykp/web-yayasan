    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
            <div class="lg:col-span-4">
                <a href="/" class="flex items-center gap-3.5 mb-4 group" aria-label="<?php echo e($shortName); ?> Home">
                    ...
                    <div>
                        ...
                        <span class="text-base font-bold text-white leading-none"><?php echo e($shortName); ?></span>
                    </div>
                </a>

                <p class="text-xs sm:text-sm text-neutral-300 leading-relaxed max-w-sm mb-6">
                    <?php echo e($foundation?->description ?: 'Bersama Mendidik, Bersama Membangun Masa Depan generasi bangsa dengan integritas dan kecerdasan seimbang.'); ?>

                </p>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($socials) && count($socials)): ?>
                    <div class="flex items-center gap-3 text-neutral-300">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a aria-label="<?php echo e(ucfirst($label)); ?>"
                                ...
                                <span class="text-[10px] font-bold uppercase"><?php echo e(mb_substr($label, 0, 2)); ?></span>
                            </a>
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="space-y-2.5 text-xs text-neutral-300 font-medium">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <li><a class="hover:text-lime transition-colors" href="<?php echo e($unit->public_url); ?>"><?php echo e($unit->title); ?></a></li>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="lg:col-span-4">
                ...
                <ul class="space-y-3 text-xs text-neutral-300">
                    ...
                    <li class="flex items-center gap-2.5">
                        ...
                        <a class="hover:text-lime transition-colors" href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $phone)); ?>"><?php echo e($phone); ?></a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($whatsapp): ?>
                            ...
                            <a class="hover:text-lime transition-colors" href="https://wa.me/<?php echo e(preg_replace('/\D/', '', $whatsapp)); ?>" target="_blank" rel="noopener noreferrer">WhatsApp</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <svg class="w-4 h-4 text-lime flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a class="hover:text-lime transition-colors" href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a>
                    </li>
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-neutral-400 gap-4">
            <p>© <?php echo e(date('Y')); ?> <?php echo e($foundationName); ?>. Hak Cipta Dilindungi.</p>
...
<?php /**PATH /Users/ferdy/project-fl/yayasan/resources/views/components/footer.blade.php ENDPATH**/ ?>