...
<span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span><?php echo e($page->text('text_1')); ?></div>
<h1 class="font-headline-2xl text-headline-2xl text-primary font-serif tracking-tight leading-tight mb-space-md"><?php echo e($page->text('text_2')); ?></h1>
<p class="font-body-xl text-body-xl text-on-surface-variant max-w-3xl leading-relaxed"><?php echo e($page->text('text_3')); ?></p>
</div>
...
<span class="font-label-sm text-label-sm font-bold text-primary tracking-wide uppercase"><?php echo e($page->text('text_4')); ?></span>
</div>
<div class="absolute bottom-6 left-6 right-6 lg:hidden text-on-primary">
<span class="font-label-sm text-label-sm text-tertiary-fixed block mb-1"><?php echo e($page->text('text_5')); ?></span>
<h3 class="font-headline-md text-headline-md font-serif text-on-primary leading-snug"><?php echo e($page->text('text_6')); ?></h3>
</div>
</div>
...
<span aria-hidden="true" class="text-[16px] font-symbols font-normal not-italic leading-none normal-case whitespace-nowrap [font-feature-settings:'liga'] [word-wrap:normal]">schedule</span><?php echo e($page->text('text_7')); ?></span>
<span class=""><?php echo e($page->text('text_8')); ?></span>
<span class=""><?php echo e($page->text('text_9')); ?></span>
</div>
<h2 class="font-headline-lg text-headline-lg font-serif text-primary leading-snug mb-space-md"><?php echo e($page->text('text_10')); ?></h2>
<p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed mb-space-lg"><?php echo e($page->text('text_11')); ?></p>
</div>
...
<div class="w-11 h-11 rounded-full bg-primary-container text-tertiary-fixed flex items-center justify-center font-serif text-headline-sm font-bold shadow-inner"><?php echo e($page->text('text_12')); ?></div>
<div class="flex flex-col">
<span class="font-label-lg text-label-lg font-bold text-primary"><?php echo e($page->text('text_13')); ?></span>
<span class="font-body-sm text-body-sm text-secondary"><?php echo e($page->text('text_14')); ?></span>
</div>
</div>
...
<div class="">
<span class="font-label-sm text-label-sm uppercase tracking-widest text-secondary font-bold block mb-1"><?php echo e($page->text('text_16')); ?></span>
<h3 class="font-headline-xl text-headline-xl font-serif text-primary"><?php echo e($page->text('text_17')); ?></h3>
</div>
...
<span class="" id="article-count-label"><?php echo e($page->text('text_18')); ?></span>
</div>
</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.news-card','data' => ['item' => $item]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<span aria-hidden="true" class="text-[16px] font-symbols font-normal not-italic leading-none normal-case whitespace-nowrap [font-feature-settings:'liga'] [word-wrap:normal]">menu_book</span><?php echo e($page->text('text_19')); ?></div>
<h3 class="font-headline-lg text-headline-lg font-serif text-primary leading-tight mb-space-sm"><?php echo e($page->text('text_20')); ?></h3>
<p class="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-space-md"><?php echo e($page->text('text_21')); ?></p>
...
<span aria-hidden="true" class="text-[18px] text-primary font-symbols font-normal not-italic leading-none normal-case whitespace-nowrap [font-feature-settings:'liga'] [word-wrap:normal]">verified</span><?php echo e($page->text('text_22')); ?></div>
</div>
...
<span class="font-label-sm text-label-sm text-secondary font-bold uppercase tracking-wider"><?php echo e($page->text('text_23')); ?></span>
<span class="font-headline-sm text-headline-sm font-serif text-primary truncate max-w-sm sm:max-w-md"><?php echo e($page->text('text_24')); ?></span>
<span class="font-body-sm text-body-sm text-outline"><?php echo e($page->text('text_25')); ?></span>
</div>
</div>
...
<div class="flex flex-col min-w-0">
<span class="font-label-sm text-label-sm text-secondary font-bold uppercase tracking-wider"><?php echo e($page->text('text_27')); ?></span>
<span class="font-headline-sm text-headline-sm font-serif text-primary truncate max-w-sm sm:max-w-md"><?php echo e($page->text('text_28')); ?></span>
<span class="font-body-sm text-body-sm text-outline"><?php echo e($page->text('text_29')); ?></span>
</div>
</div>
...
<div class="flex flex-col min-w-0">
<span class="font-label-sm text-label-sm text-secondary font-bold uppercase tracking-wider"><?php echo e($page->text('text_31')); ?></span>
<span class="font-headline-sm text-headline-sm font-serif text-primary truncate max-w-sm sm:max-w-md"><?php echo e($page->text('text_32')); ?></span>
<span class="font-body-sm text-body-sm text-outline"><?php echo e($page->text('text_33')); ?></span>
</div>
</div>
...
<h3 class="font-headline-xl text-headline-xl font-serif text-on-primary leading-tight mb-space-xs"><?php echo e($page->text('text_35')); ?></h3>
<p class="font-body-lg text-body-lg text-primary-fixed leading-relaxed mb-space-xl max-w-2xl"><?php echo e($page->text('text_36')); ?></p>

<?php if (isset($component)) { $__componentOriginal521bc4557fc090d59d6deca79f219ffc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal521bc4557fc090d59d6deca79f219ffc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.newsletter-form','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('newsletter-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal521bc4557fc090d59d6deca79f219ffc)): ?>
<?php $attributes = $__attributesOriginal521bc4557fc090d59d6deca79f219ffc; ?>
<?php unset($__attributesOriginal521bc4557fc090d59d6deca79f219ffc); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal521bc4557fc090d59d6deca79f219ffc)): ?>
<?php $component = $__componentOriginal521bc4557fc090d59d6deca79f219ffc; ?>
<?php unset($__componentOriginal521bc4557fc090d59d6deca79f219ffc); ?>
<?php endif; ?>
...
<span class=""><?php echo e($page->text('text_37')); ?></span>
</div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ferdy/project-fl/yayasan/resources/views/pages/news.blade.php ENDPATH**/ ?>